...
<h3 class="passtitle"><?php _e( 'Change password', 'tdl_framework' ); ?></h3>
...
<?php if ($username == "demo") { ?>
	<p><?php _e("You are not being able to change the password for this demo account.", "tdl_framework"); ?></p>
<?php } else { ?>
