jQuery(document).ready(function($){
  ...
  calcPercent();
    ...
    function update_shortcode(ending){
		...
		$('#options-'+name+' select:not(".dynamic-select, [multiple=multiple]")').each(function(){
    ...
    $('#tdl-shortcodes').change(function(){
	...
	function resetFileds(){
		//reset data
		$('#tdl-sc-generator').find('input:text, input:password, input:file, textarea').val('');
		$('#tdl-sc-generator').find('select:not(#tdl-shortcodes) option:first-child').attr("selected", "selected");
		$('#tdl-sc-generator').find('input:radio, input:checkbox').removeAttr('checked').removeAttr('selected');
		$('#tdl-sc-generator').find('.shortcode-options').each(function(){
		...
		$('#tdl-sc-generator').find('.redux-opts-screenshot').attr('src','');
		$('#tdl-sc-generator').find('.redux-opts-upload-remove').hide();
		$('#tdl-sc-generator').find('.redux-opts-upload').show();
		$('#tdl-sc-generator').find('.wp-color-result').attr('style','');
	}
