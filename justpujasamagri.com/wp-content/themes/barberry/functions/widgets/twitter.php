...
class WP_Widget_Custom_Twitter extends WP_Widget {
	...
	function WP_Widget_Custom_Twitter() {
		$widget_ops = array( 'classname' => 'widget_twitter', 'description' => __( "A list of last tweets" , 'tdl_framework') );
		$this->WP_Widget('Barberry_twitter', __('Barberry: Twitter', 'tdl_framework'), $widget_ops);
	}
						...
						<div class="wig_twitbox">
							...
							<div class="tweetitem">
                            	<div class="tweet_content">
                                    ...
                                    ?>
                                    <a href="http://twitter.com/<?php echo $tweet->user->screen_name; ?>/statuses/<?php echo $tweet->id_str; ?>" class="jtwt_date"><?php echo $timeAgo; ?></a></small>
								</div>
                            </div>
							<?php endforeach; ?>
						</div>
...
add_action( 'widgets_init', 'tdl_widget_posts' );
function tdl_widget_posts() {
